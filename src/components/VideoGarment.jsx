...
export default function VideoGarment({ product, position, onClick, visible, videoSrc, posterSrc, bgType = 'black', showLabels = false, displayScale, labelOffset }) {
  ...
  return (
    ...
    >
      ...
      {showLabels && (
        <Html
          position={labelOffset || [0, -0.95, 0.3]}
          center
          distanceFactor={6}
